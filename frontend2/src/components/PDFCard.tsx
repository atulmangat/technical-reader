...
export const PDFCard = ({title, thumbnailUrl, uploadedAt, onClick}: IPDFCard) => {
    return (<Card onClick={onClick}>
        ...
        <CardContent>
            ...
            {thumbnailUrl ? (<img src={thumbnailUrl} alt={title} className='w-full h-full object-cover'></img>)
